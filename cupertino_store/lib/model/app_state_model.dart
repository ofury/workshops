//AppStateModel shows a way of centralizing the state of the application,
//and making the state available throughout the whole application.
//In later steps we will use this state to drive our Search and Shopping Cart functionality.
